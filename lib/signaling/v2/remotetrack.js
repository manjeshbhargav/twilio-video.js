...
/**
 * Get the {@link RemoteTrackV2#Representation} of a given {@link TrackSignaling}.
 * @param {TrackSignaling} track
 * @returns {RemoteTrackV2#Representation}
 */
RemoteTrackV2.getState = function getState(track) {
  return {
 ...
 * @typedef {LocalTrackV2#Representation} RemoteTrackV2#Representation
