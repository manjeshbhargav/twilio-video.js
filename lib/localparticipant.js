...
LocalParticipant.prototype._handleTrackSignalingEvents = function _handleTrackSignalingEvents() {
  ...
  function localTrackAdded(localTrack) {
    signaling.addTrack(signaling._createPublishedTrack(localTrack));
  ...
  function localTrackDisabled(localTrack) {
    var trackSignaling = signaling._getPublishedTrack(localTrack);
    trackSignaling.disable();
    log.info('Disabled the ' + util.trackClass(localTrack, true) + ':', localTrack.id);
    log.debug(util.trackClass(localTrack, true) + ':', localTrack);
  }
  ...
  function localTrackEnabled(localTrack) {
    ...
    log.info('Enabled the ' + util.trackClass(localTrack, true) + ':', localTrack.id);
    log.debug(util.trackClass(localTrack, true) + ':', localTrack);
  }

  function localTrackRemoved(localTrack) {
    signaling.removeTrack(signaling._getPublishedTrack(localTrack));
